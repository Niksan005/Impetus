...
IL_007d:
		{
			...
			ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* L_34 = VirtFuncInvoker0< ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* >::Invoke(31 /* System.Byte[] System.IO.MemoryStream::ToArray() */, L_33);
			V_5 = L_34;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeUriString_mD6C6C27478BADC8EDF42621924F2ACD6D1B21E7D (Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * ___targetUri0, String_t* ___targetUrl1, bool ___prependProtocol2, const RuntimeMethod* method)
{
	...
	}
	{
		...
		Il2CppChar L_10 = String_get_Chars_m9B1A5E4C8D70AA33A60F03735AF7B77AB9DBBA70(L_7, ((int32_t)il2cpp_codegen_add((int32_t)L_9, (int32_t)1)), /*hidden argument*/NULL);
...
IL_0033:
	...
	}
	{
		...
		StringBuilder_Append_m1ADA3C16E40BF253BCDB5F9579B4DBA9C3E5B22E(L_16, ((int32_t)58), /*hidden argument*/NULL);
		String_t* L_17 = V_0;
		bool L_18 = String_op_Equality_m2B91EE68355F142F67095973D32EB5828B7B73CB(L_17, _stringLiteralEB3DF58228CDA6AA5325549ADFCEDF52FC5CBF6A, /*hidden argument*/NULL);
		V_3 = L_18;
		bool L_19 = V_3;
		if (!L_19)
		{
	...
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_20 = ___targetUri0;
		String_t* L_21 = Uri_get_AbsolutePath_mB845A99D0CEB442AAF90B24A95EE7509C34C6306(L_20, /*hidden argument*/NULL);
		V_4 = L_21;
		String_t* L_22 = V_4;
		bool L_23 = String_Contains_mA26BDCCE8F191E8965EB8EEFC18BB4D0F85A075A(L_22, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, /*hidden argument*/NULL);
		V_5 = L_23;
		bool L_24 = V_5;
		if (!L_24)
		{
	...
	}
	{
		String_t* L_25 = V_4;
		IL2CPP_RUNTIME_CLASS_INIT(WebRequestUtils_t3FE2D9FD71A02CD3AF8C91B81280F59E5CF26392_il2cpp_TypeInfo_var);
		String_t* L_26 = WebRequestUtils_URLDecode_m1B0D9D85074E0B8390C890B9E56F389F4EC6C8DF(L_25, /*hidden argument*/NULL);
		V_4 = L_26;
	}
...
IL_0087:
	{
		String_t* L_27 = V_4;
		bool L_28 = String_StartsWith_mDE2FF98CAFFD13F88EDEB6C40158DDF840BFCF12(L_27, _stringLiteral225454A90D745E7A7A5DE5C12169566FBC05370D, /*hidden argument*/NULL);
		if (!L_28)
		{
			goto IL_00b0;
		}
	...
	{
		String_t* L_31 = V_4;
		Il2CppChar L_32 = String_get_Chars_m9B1A5E4C8D70AA33A60F03735AF7B77AB9DBBA70(L_31, 6, /*hidden argument*/NULL);
...
IL_00b1:
	...
	}
	{
		...
		StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_34, _stringLiteral218F5A08519088A96BE3C1074984C53EA49F1CCA, /*hidden argument*/NULL);
		StringBuilder_t * L_35 = V_2;
		String_t* L_36 = V_4;
		String_t* L_37 = String_Substring_mB6B87FD76552BBF6D4E2B9F07F857FE051DCE190(L_36, 5, /*hidden argument*/NULL);
		StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_35, L_37, /*hidden argument*/NULL);
		goto IL_00df;
	}
...
IL_00d6:
	{
		...
		String_t* L_39 = V_4;
		StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_38, L_39, /*hidden argument*/NULL);
	}
...
IL_00e9:
	{
		...
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_43 = ___targetUri0;
		String_t* L_44 = Uri_get_PathAndQuery_m0FFF28F15DF953C5866C2A0DEEA2034ECE6A0F35(L_43, /*hidden argument*/NULL);
		StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_42, L_44, /*hidden argument*/NULL);
		StringBuilder_t * L_45 = V_2;
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_46 = ___targetUri0;
		String_t* L_47 = Uri_get_Fragment_m1734B2D3F27F38AA342CB65885DE732160501E72(L_46, /*hidden argument*/NULL);
		StringBuilder_Append_mD02AB0C74C6F55E3E330818C77EC147E22096FB1(L_45, L_47, /*hidden argument*/NULL);
...
IL_010d:
	{
		...
		bool L_51 = String_Contains_mA26BDCCE8F191E8965EB8EEFC18BB4D0F85A075A(L_50, _stringLiteral6C066B34F4DB79023C0642AFBC43B25A5327F710, /*hidden argument*/NULL);
		V_8 = L_51;
		bool L_52 = V_8;
		if (!L_52)
		{
	...
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_53 = ___targetUri0;
		String_t* L_54 = Uri_get_OriginalString_mBD94B4BB84AE9C051C1CA8BA33C14D5BAD25B0AC(L_53, /*hidden argument*/NULL);
		V_7 = L_54;
		goto IL_0132;
	}
...
IL_0128:
	{
		Uri_t4A915E1CC15B2C650F478099AD448E9466CBF612 * L_55 = ___targetUri0;
		String_t* L_56 = Uri_get_AbsoluteUri_mC494374C2A3B1DFC9C3DC6CCB8A8A758580C11DA(L_55, /*hidden argument*/NULL);
		V_7 = L_56;
		goto IL_0132;
	}
